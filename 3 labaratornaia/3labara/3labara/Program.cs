...
namespace ЛР__3
{
    class Program
    {
        public partial class Abiturient
        {
            ...
            public Abiturient(string Place, string Time, string DayOfWeek, int Num = 5)
            {
            ...
            public Abiturient(int Num, string Place)
            {
                num = Num;
                place = Place;
                time = "10:00";
        ...
        static void print(Abiturient airline)
        ...
        {
            Abiturient[] airlines = new Abiturient[5];
            airlines[0] = new Abiturient(1, "Минск");
            airlines[1] = new Abiturient();
            airlines[2] = new Abiturient("Пекин", "21:50", "Четверг", 3);
            airlines[3] = new Abiturient("Сочи", "8:45", "Пятница", 4);
            airlines[4] = new Abiturient("Минск", "22:10", "Суббота");
